...
mint_output="$(php_run "$APP_DIR/artisan" bfc:credential:mint installation sink-verify-installation --kind=bearer --purpose=sink.ingest --abilities=consumption --name="${1#--app=}" --local --no-interaction)"

...
mint_output="$(php_run "$APP_DIR/artisan" bfc:credential:mint installation sink-verify-installation --kind=bearer --purpose=consumption --name="${1#--app=}" --local --no-interaction)"

...
Route::delete('inbox', PurgeMessagesController::class)->name('sink.inbox.purge');
...
Route::delete('inbox/{message}', DestroyMessageController::class)->name('sink.message.destroy');

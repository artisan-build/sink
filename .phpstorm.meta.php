...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.sink.driver' => 'string',
            'database.connections.sink.url' => 'NULL',
            'database.connections.sink.database' => 'string',
            'database.connections.sink.prefix' => 'string',
            'database.connections.sink.foreign_key_constraints' => 'boolean',
            'database.connections.sink.busy_timeout' => 'NULL',
            'database.connections.sink.journal_mode' => 'NULL',
            'database.connections.sink.synchronous' => 'NULL',
            'database.connections.sink.transaction_mode' => 'string',
            ...
            'filesystems.links./Users/edgrosvenor/Herd/sink-wt/pr8b-skills/public/storage' => 'string',
            ...
            'sink-server.route_prefix' => 'string',
            'sink-server.queue' => 'NULL',
            'sink-server.disk' => 'string',
            'sink-server.database.connection' => 'string',
            'sink-server.database.host' => 'NULL',
            'sink-server.database.port' => 'NULL',
            'sink-server.database.database' => 'NULL',
            'sink-server.database.username' => 'NULL',
            'sink-server.database.password' => 'NULL',
            'sink-server.retention.days' => 'integer',
            'sink-server.retention.max_messages' => 'NULL',
            'sink-server.retention.max_total_bytes' => 'NULL',
            'sink-server.mcp.path' => 'string',
            'sink-server.mcp.local_name' => 'string',
...
'database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.sink.driver','database.connections.sink.url','database.connections.sink.database',
'database.connections.sink.prefix','database.connections.sink.foreign_key_constraints','database.connections.sink.busy_timeout','database.connections.sink.journal_mode','database.connections.sink.synchronous',
'database.connections.sink.transaction_mode','database.migrations.table','database.migrations.update_date_on_publish','database.redis.client','database.redis.options.cluster',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/edgrosvenor/Herd/sink-wt/pr8b-skills/public/storage',
...
'session.serialization','built-for-cloud.fallback_token','built-for-cloud.token_prefix','built-for-cloud.cloud.binary','built-for-cloud.cloud.application',
'gh.default_options.alias.set','gh.default_options.alias.delete','gh.default_options.alias.list','gh.default_options.auth.login','gh.default_options.auth.logout',
'gh.default_options.auth.status','gh.default_options.auth.token','gh.default_options.browse','gh.default_options.gist.create','gh.default_options.gist.list',
'gh.default_options.gist.view','gh.default_options.gist.edit','gh.default_options.gist.delete','gh.default_options.issue.create','gh.default_options.issue.list',
'gh.default_options.issue.view','gh.default_options.issue.close','gh.default_options.issue.reopen','gh.default_options.issue.edit','gh.default_options.pr.create',
'gh.default_options.pr.list','gh.default_options.pr.view','gh.default_options.pr.close','gh.default_options.pr.reopen','gh.default_options.pr.edit',
'gh.default_options.pr.merge','gh.default_options.release.create','gh.default_options.release.delete','gh.default_options.release.list','gh.default_options.release.view',
'gh.default_options.release.edit','gh.default_options.release.upload-asset','gh.default_options.repo.archive','gh.default_options.repo.clone','gh.default_options.repo.create',
'gh.default_options.repo.delete','gh.default_options.repo.deploy-key','gh.default_options.repo.view','gh.default_options.repo.fork','gh.default_options.repo.list',
'gh.default_options.repo.set-default','gh.default_options.repo.unarchive','gh.default_options.secret.set','gh.default_options.secret.list','gh.default_options.secret.delete',
'kibble.path','kibble.organization','kibble.template','kibble.homepage','kibble.github_token',
'kibble.github_username','packagist.username','packagist.main_token','packagist.safe_token','sink-server.route_prefix',
'sink-server.queue','sink-server.disk','sink-server.database.connection','sink-server.database.host','sink-server.database.port',
'sink-server.database.database','sink-server.database.username','sink-server.database.password','sink-server.retention.days','sink-server.retention.max_messages',
'sink-server.retention.max_total_bytes','sink-server.mcp.path','sink-server.mcp.local_name','boost.enabled','boost.browser_logs_watcher',
...
'mcp.custom_schemes','mcp.authorization_server','livewire.component_locations','livewire.component_namespaces.layouts','livewire.component_namespaces.pages',
...
'sink-server.ingest','sink-server.capabilities','sink.inbox','sink.inbox.purge','sink.message.body',
'sink.message.raw','sink.message.attachment','sink.message.destroy','sink.message','boost.browser-logs',
...
'register.invitation','dashboard','invitations','profile.edit',
'appearance.edit','security.edit','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'75f2147a37360bc74f25726bdb92e31e::app-logo','75f2147a37360bc74f25726bdb92e31e::app-logo-icon','75f2147a37360bc74f25726bdb92e31e::auth-header','75f2147a37360bc74f25726bdb92e31e::auth-session-status','75f2147a37360bc74f25726bdb92e31e::desktop-user-menu',
'75f2147a37360bc74f25726bdb92e31e::passkey-registration','75f2147a37360bc74f25726bdb92e31e::passkey-verify','75f2147a37360bc74f25726bdb92e31e::placeholder-pattern','75f2147a37360bc74f25726bdb92e31e::settings.layout','18834f6d8a4fcb337df7eedd9624e079::admin.invitations',
'18834f6d8a4fcb337df7eedd9624e079::auth.accept-invitation','18834f6d8a4fcb337df7eedd9624e079::auth.confirm-password','18834f6d8a4fcb337df7eedd9624e079::auth.forgot-password','18834f6d8a4fcb337df7eedd9624e079::auth.login','18834f6d8a4fcb337df7eedd9624e079::auth.reset-password',
'18834f6d8a4fcb337df7eedd9624e079::auth.two-factor-challenge','18834f6d8a4fcb337df7eedd9624e079::auth.verify-email','18834f6d8a4fcb337df7eedd9624e079::settings.appearance','18834f6d8a4fcb337df7eedd9624e079::settings.delete-user-form','18834f6d8a4fcb337df7eedd9624e079::settings.profile',
'18834f6d8a4fcb337df7eedd9624e079::settings.security','18834f6d8a4fcb337df7eedd9624e079::settings.two-factor.recovery-codes','admin.invitations','app-logo','app-logo-icon',
'auth-header','auth-session-status','auth.accept-invitation','auth.confirm-password','auth.forgot-password',
'auth.login','auth.reset-password','auth.two-factor-challenge','auth.verify-email','components.app-logo',
'components.app-logo-icon','components.auth-header','components.auth-session-status','components.desktop-user-menu','components.passkey-registration',
'components.passkey-verify','components.placeholder-pattern','components.settings.layout','dashboard','desktop-user-menu',
...
'layouts::auth.split','livewire.admin.invitations','livewire.auth.accept-invitation','livewire.auth.confirm-password','livewire.auth.forgot-password',
'livewire.auth.login','livewire.auth.reset-password','livewire.auth.two-factor-challenge','livewire.auth.verify-email','livewire.settings.appearance',
'livewire.settings.delete-user-form','livewire.settings.profile','livewire.settings.security','livewire.settings.two-factor.recovery-codes','partials.head',
'partials.settings-heading','passkey-registration','passkey-verify','placeholder-pattern','settings.appearance',
'settings.delete-user-form','settings.layout','settings.profile','settings.security','settings.two-factor.recovery-codes',
'sink-server::livewire.inbox-list','sink-server::livewire.message-detail','welcome','e60dd9d2c3a62d619c9acb38f20d5aa5::accent','e60dd9d2c3a62d619c9acb38f20d5aa5::aside',
